...
<head>
  ...
  <style>
    * {
    ...
    .rundown-table tbody tr.highlighted {
      background: #fef9c3 !important;
      border-left: 4px solid #eab308;
    }

    .rundown-table tbody tr.highlighted td:first-child {
      padding-left: 12px;
    }
...
<body>
  <div class="container">
    ...
    <div class="summary">
      ...
      ${data.contactEmail ? `<span><strong>Contact :</strong> ${escapeHtml(data.contactEmail)}</span>` : ''}
    </div>
    ...
    <div class="footer">
      <p>
        Ce conducteur vous a ete envoye par ${escapeHtml(data.senderName)}.<br>
        <em>Les lignes en jaune indiquent vos passages a l'antenne.</em>
      </p>
      <p style="margin-top: 12px;">
        Propulse par <a href="https://redacnews.link">RedacNews</a>
      </p>
    </div>
  </div>
</body>
